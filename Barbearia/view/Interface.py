...
class Tabela(CTkScrollableFrame):
    def __init__(self,root, Caixa=None, principal=None):
        ...
        entry.append(CTkEntry(self,120,30,fg_color="white",text_color="black",font=CTkFont(size=15),placeholder_text="Preço"))
...
class ClienteFrame(CTkScrollableFrame):
    def __init__(self,master):
        ...
        pesquisa=CTkEntry(self,70,20,fg_color="white",placeholder_text="Pesquisar",text_color="black")
